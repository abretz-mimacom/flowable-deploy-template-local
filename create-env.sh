...
echo "Connecting the shared Postgres/Elasticsearch/Keycloak containers to the kind network"
for container in docker-flowable-db-1 docker-flowable-index-1 docker-flowable-keycloak-1; do
...
echo "  stg  - Work: http://localhost/stg/work/   Control: http://localhost/stg/control/  (Keycloak login: admin/admin)"
echo "  Keycloak admin console: http://localhost:9095/  (admin/admin)"
echo "  phpLDAPadmin (browse LDAP): http://localhost:9096/"
